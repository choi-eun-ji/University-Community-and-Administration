...
public class EunjiBoardDAO implements InterEunjiBoardDAO {
	...
	@Override
	public List<Map<String, String>> getCalendar(int memberNo) {
		List<Map<String, String>> callist = sqlSession.selectList("eunji.getCalendar", memberNo);
		return callist;
	}

	@Override
	public int addCalendar(Map<String, String> map) {
		int n = sqlSession.insert("eunji.addCalendar", map);
		return n;
	}

	@Override
	public int deleteCalendar(Map<String, String> map) {
		int n = sqlSession.delete("eunji.deleteCalendar", map);
		return n;
	}
