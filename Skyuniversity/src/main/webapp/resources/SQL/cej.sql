...
drop table tbl_cal_subject purge
commit
create table tbl_cal_subject
(
calenderseq     number
,title   varchar2(300) 
,startcal   varchar2(100)
,endcal     varchar2(100)
,groupid number
,url     varchar2(300)
,fk_memberno number not null
,constraint PK_tbl_cal_subject_calenderseq primary key(calenderseq)
,constraint FK_tbl_cal_subject_memberno  foreign key(fk_memberno) 
                                   references tbl_member(memberno)
);

create sequence tbl_subject_calender_seq
start with 1
increment by 1
nomaxvalue
nominvalue
...
values(tbl_subject_calender_seq.nextval, '운영체제 복습하기', '2021-01-11', '2021-01-13', '102');
insert into tbl_cal_subject(calenderseq, title, startcal, endcal, fk_memberno)
values(tbl_subject_calender_seq.nextval, '프로젝트 구상', '2021-01-17', '2021-01-20', '102');
...
delete from tbl_cal_subject where title = '운영체제 복습하기' and startcal = '2021-01-11' and endcal = #{endcal} and fk_memberno = #{memberno}

delete from tbl_cal_subject where calenderseq = '8'